      ...
      <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 relative bottom-10">
        <div class="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
          <div class="w-full lg:w-6/12">
            <h2 class="w-full font-bold lg:text-4xl text-3xl lg:leading-10 dark:text-black leading-9">
              We are here to make great design accessible and delightfull for
              everyone
            </h2>
            <p class="font-normal text-base leading-6 text-gray-900 dark:text-gray-900 mt-6">
        ...
        <div class="relative mt-24">
          ...
          <hr class="z-10 absolute top-2/4 w-full bg-gray-900" />
        </div>
        <div class="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          <div>
            <p class="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 dark:text-black mt-6">
              Founded
            </p>
            <p class="font-normal text-base leading-6 text-gray-900 dark:text-gray-900 mt-6">
              It is a long established fact that a reader will be distracted by
        ...
        <div class="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
          <div class="w-full lg:w-6/12">
            <h2 class="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 dark:text-black">
              Our Mission
            </h2>
            <p class="font-normal text-base leading-6 text-gray-900 dark:text-gray-900 mt-6 w-full lg:w-10/12 xl:w-9/12">
              It is a long established fact that a reader will be distracted by
              the readable content of a page when looking at its layout. The
              point of using Lorem Ipsum.In the first place we have granted to
              God, and by this our present charter confirmed for us and our
            ...
            <p class="font-normal text-base leading-6 text-gray-900 dark:text-gray-900 w-full lg:w-10/12 xl:w-9/12 mt-10">
              It is a long established fact that a reader will be distracted by
              the readable content of a page when looking at its layout. The
              point of using Lorem Ipsum.In the first place we have granted to
              God, and by this our present charter confirmed for us and our
          ...
          <div class="w-full lg:w-6/12">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
              <div class="flex p-4 shadow-md">
                ...
                <div class="">
                  <p class="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 dark:text-black">
                    Team
                  </p>
                  <p class="mt-2 font-normal text-base leading-6 text-gray-900 dark:text-gray-900">
        ...
        <form className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              id="name"
              type="text"
              className="w-full border-black-300 rounded-md p-2"
            />
          </div>
          <div>
          ...
          <div className="col-span-2">
            <button
              type="submit"
              className="bg-blue-500 text-black py-2 px-4 rounded-md hover:bg-blue-600 transition duration-200"
            >
              Send
            </button>
          </div>
