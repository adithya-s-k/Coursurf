  ...
  return (
      ...
      <div>
        ...
        <div className="three">
          ...
          <div className="Info">
            <p>
              We all negotiate on a daily basis. On a personal level, we
              negotiate with friends, family, landlords, car sellers and
              employers, among others. Negotiation is also the key to business
              success. No business can survive without profitable contracts.
              Within a company, negotiation skills can lead to your career
              advancement.
              {/* <span id="points">...</span>
            <span id="moreText"> */}
              <br /> <br />I hope that you will join the hundreds of thousands
              of learners who have made “Successful Negotiation” one of the most
              popular and highly-rated MOOCs worldwide. In the course, you’ll
              learn about and practice the four steps to a successful
              negotiation: <br />
              <br />
              ...
              learner compared the course to “House of Cards.” Both shows
              contain interesting examples of complex negotiations! <br />{" "}
              <br />
              ...
              partner will give you feedback on your negotiation skills. To
              assist you with your negotiations, I have developed several free
              negotiating planning tools that are related to the course. These
              tools and a free app are available at
              http://negotiationplanner.com/ <br /> <br />
              ...
              <br /> <br />
              This course is also available in Spanish and Portuguese. To join
              the fully translated Spanish version, visit this page:
        ...
        <div className="Syllabus">
          ...
          <div className="sub">
            ...
            personal life and business transactions. After completing this
            module, youll be able to state the four key stages of negotiation
            and what you need to do successfully complete this course
          </div>
          <br />
          ...
          <div className="sub">
            ...
            planning for a negotiation. One critical component you&#39;ll learn
            is how to complete a negotiation analysis to set you up for success
          </div>
          <br />
          ...
          <div className="sub">
            This module focuses on two especially important topics: (1) how to
            use power during negotiations and (2) psychological tools that you
            can use during negotiations. Keep a paper and pencil handy, as youll
            be participating in several experiments as watch these videos &apos;
          </div>
          <br />
          ...
          <div className="sub">
            This module focuses on the negotiation that takes place in a
            business deal after reaching an initial agreement the negotiation to
            create a binding contract. Among other things, youll learn to decide
            if you need a lawyer or can act as your own for contract creation.
            However, the videos should not be construed as providing legal
            advice.
          </div>
          <br />
          ...
          <div className="sub">
            ...
            successfully completed the course! The estimated time to complete
            the examination is 75 minutes. You can retake the examination until
            you are confident that you understand these concepts.
          </div>
        </div>
      </div>
